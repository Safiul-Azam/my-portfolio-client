...
const Header = () => {
    ...
    return (
        <div class="navbar bg-accent fixed top-0 z-20">
            <div class="navbar-start w-full justify-between flex-row-reverse">
                <div class="dropdown text-white mt-2">
                    <label tabIndex="0" class="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </label>
                    <ul tabIndex="0" class="menu menu-compact dropdown-content p-4 shadow w-32 text-white bg-accent">
                        {menu}
                    </ul>
                </div>
